      ...
      {invoice && (
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            Invoice <span className="font-mono font-bold text-gray-800">{invoice.invoiceNumber}</span>
          </p>
          ...
          <dl className="mt-5 space-y-1.5 text-sm text-left rounded-xl border border-gray-100 bg-gray-50/60 p-4">
            <div className="flex justify-between">
              ...
              <dd className="font-bold text-gray-900 tabular-nums">{money(invoice.totalAmount)}</dd>
            </div>
            ...
            {invoice.changeAmount > 0 && (
              <div className="flex justify-between border-t border-gray-200 pt-2 mt-1">
                ...
                <dd className="text-xl font-extrabold text-green-700 tabular-nums">{money(invoice.changeAmount)}</dd>
              </div>
            )}
          </dl>
